...
2.  **Formulate a question.** I recommend keeping this simple and limiting to no more than one or two questions. Your question(s) should be appropriate to your data set and ideally be answered by applying concepts and skills from our essential readings and case studies. For example, you may be interested in examning researchers' reactions to online conferences by conducting sentiment analysis with tweeter data.
