---
title: "Unsupervised Machine Learning in Text Mining"
...
-   Common Tools: LDA (Topic Modeling) & K-Means Clustering.
...
This module will focus on Latent Dirichlet Allocation (LDA), a form of topic modeling.
:::
...
**1. Text Preprocessing:** `SnowballC` provides stemming capabilities to reduce words to their root forms, improving consistency in topic modeling.
...
**4. Visualization & Interpretation:** `LDAvis` provides an interactive visualization tool for exploring LDA topic distributions and word associations.
...
[![from Text Mining with R (2017)](images/clipboard-2397679599.png){width="789"}](https://www.tidytextmining.com/)
