...
And let's take a quick look at `tweets` DataFrame to make sure it contains both "ngss" and "ccss" standards:
...
csss_sentiment_over_time = csss_data.resample('D', on='created_at')['compound'].mean().reset_index()
