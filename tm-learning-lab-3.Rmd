...
VADER can take a little while to run since it's computationally intensives so let's first take at just a sample of 500 untidied CCSS tweets using the `sample_n()` function
