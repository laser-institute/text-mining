...
::: notes
ENA is a common analysis to support QE because it carries out the principle of mapping relationships of ideas. You can stretch this algorithm to account for a range of conditions within a learning event. If it's a conversation between two students, you can acknowledge their dialogue. If it's groups of students working concurrently, you can account for that structure. This gives it more nuance than simply tidying all text into a bag of words, or even LDA which acknowledges distinct documents.
:::
...
::: notes
Thankfully there are methods of comparing even larger data, which is better explored in our readings and case study for the week.
:::
