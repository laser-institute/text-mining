...
![uses tidytext for sentiment analysis.](img/sentiment-flow.png "Figure 2.1: A flowchart of a typical text analysis that uses tidytext for sentiment analysis. This chapter shows how to implement sentiment analysis using tidy data principles."){width="90%"}
...
The {Vader} package is Valence Aware Dictionary for sEntiment Reasoning (VADER) is a rule-based model for sentiment analysis of social media text .
...
a.  **Get Sentiments**. We conclude our data wrangling by introducing sentiment lexicons and the `inner_join()` function for appending sentiment values to our data frame.

b.  **Join Sentiment.**

### 2a. Get Sentiment Values

Recall from TM Learning Lab 1
