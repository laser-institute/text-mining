...
Not quite as bleak as we might have expected according to VADER! But then again, the VADER bring an entirely different perspective coming from the dark side.
