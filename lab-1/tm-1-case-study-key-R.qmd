...
![Figure 2.2 Steps of Data-Intensive Research Workflow](img/workflow.png){alt="Figure 2.2 Steps of Data-Intensive Research Workflow"}
...
![Create New File](img/file.png){alt="Create New File"}
