---
title: "Unit 1 Walkthrough: Tidy Text & Word Counts"
...
research question next week, using the provided dataset or dataset of
your own choosing.
...
While we won't investigate approaches to **Model** our data until Unit 3
when we learn about topic models, we will be developing "data products"
next week to **Communicate** our findings and insights.
...
-   **Word Search**. We learn about the global regular expression
    ...
    data set.
-   **Data Visualization**. Finally, we wrap up this walkthrough and
...
You can also find an example of a brief written report here:
<https://moodle-courses2021.wolfware.ncsu.edu/pluginfile.php/1719158/mod_forum/intro/Vandenberg%20Summary.pdf>
