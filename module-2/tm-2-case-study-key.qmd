...
Before we dig into sentiment, let's use the handy {dplyr} and {ggplot2} packages to take a very quick look at the number of daily tweets over the first 5 months of 2020:
...
Collectively, it looks like our combined dataset has more negative words than positivewords.
...
Looks like CCSS have far more negative words than positive, while NGSS skews much more positive. So far, pretty consistent with Rosenberg et al.'s findings!
