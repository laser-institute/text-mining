...
Since one of our goals for this Learning Lab is a simplistic replication of the study by Rosenberg et al. (2021), let's begin by introducing the `search_tweets()` function.

In your guided practice file, run the following code for reading into R 5,000 tweets containing the NGSS hashtag and store as a new data frame `ngss_tweets_q1`:
