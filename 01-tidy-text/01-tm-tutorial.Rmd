...
To help us better understand the packages, Twitter API tools, and data we'll be using during this Learning Lab, in this section we'll learn to:

a.  **Load Packages** for tidy text mining and using Twitter APIs
b.  **Create a Twitter App** for
c.  **Authorization RStudio** and create a token for
...
To help us better understand the packages, Twitter API tools, and data we'll be using during this Learning Lab, this section will focus on:

a.  **R Packages** for tidy text mining and Twitter APIs
b.  Setting up your first **Twitter App**
c.  **Authorization methods** for linking R with your developer account
...
If you are interested in viewing an alternate browser-based authentication method, you can view his vignette by running the following code:
...
If you are interested in viewing an alternate browser-based authentication method, you can view `rtweet` Twitter authorization vignette by running the following code:
...
View your new `ccss_tweets` data frame using one of the previous view methods from Unit 1 Section 2a to help answer the following questions:
