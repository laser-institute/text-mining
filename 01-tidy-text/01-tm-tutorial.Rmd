...
3.  Assign your search to a new object with an appropriate name.

4.  Output your new dataset using the `datatable()` function from the `DT` package.
...
```{r}
tidy_tweets <- anti_join(ccss_unigrams,
                         stop_words,
                         by = "word")
