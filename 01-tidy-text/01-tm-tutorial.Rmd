...
<img src="files/create-app-6.png" alt="create-app-6" width="80%"/>

3.  Scroll down to `Access token & access token secret` and click `Create`

<img src="files/create-app-7.png" alt="create-app-7" width="80%"/>
...
Tidy your `my_tweets` dataset from the [Your Turn ⤵] in Section 2a by tokenizing your text into unigrams and removing stop words.
