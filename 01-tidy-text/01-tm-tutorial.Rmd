...
Notice the unique syntax required for the query argument. For example, when "OR" is entered between search terms, `query = "#NGSSchat OR ngss"`, Twitter's REST API should return any tweet that contains either "\#NGSSchat" or "ngss." It is also possible to search for exact phrases using double quotes. To do this, either wrap single quotes around a search query using double quotes, e.g., `q = '"next generation science standards"'` as we did above, or escape each internal double quote with a single backslash, e.g., `q = "\"next generation science standards\""`.
